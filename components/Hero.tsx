...
function Hero() {
  return (
    <div className='flex flex-col justify-start lg:justify-center items-center lg:grid  lg:grid-cols-2 px-2 lg:py-12 sm:py-6 md:px-12 text-gray-800 text-center lg:text-left lg:gap-x-16 bg-[url("/marbel.webp")] bg-center min-h-screen lg:min-h-[75vh]  pt-4'>
