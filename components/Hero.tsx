...
function Hero() {
  return (
    <div className='flex flex-col justify-center items-center lg:grid  lg:grid-cols-2 px-2 lg:py-12 sm:py-6 md:px-12 text-gray-800 text-center lg:text-left lg:gap-x-16 bg-[url("/marbel.webp")] bg-center min-h-screen'>

       <div className='mb-4'>
       <h1 className="leading-[3.3rem] mt-[-5rem] md:m-0  text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12 text-white"><span className="text-red-600 text-6xl lg:text-9xl">novo</span> <br />Porcelanatos <br /></h1>
