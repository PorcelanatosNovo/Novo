  ...
  return (
    ...
    <div className="block rounded-lg shadow-lg">
      <div className="flex flex-wrap items-center">
        <a href='https://novoporcelanatos468381923.mercadoshops.com.ar' target="_blank" rel='noopener noreferrer' className="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12 p-2 ">
        ...
        <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
          <div className="px-6 py-12 md:px-12">
            <a href="https://novoporcelanatos468381923.mercadoshops.com.ar" rel='noopener noreferrer' target='_blank'><h2 className="text-3xl font-bold mb-6 pb-2 text-white">Visita nuestra <span className='uppercase text-red-600'>Tienda Web</span></h2></a>
