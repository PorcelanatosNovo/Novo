...
<span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">nuevos <span className='text-red-600'>Porcelanatos</span></span>
</a>
...
<span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">nuevos Porcelanatos™</a>. Todos los derechos reservados.
</span>
</footer>
