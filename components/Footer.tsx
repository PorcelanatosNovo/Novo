...
<span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"><span className='text-red-600'>nuevos</span> Porcelanatos</span>
</a>
...
<span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <span className="hover:underline">nuevos Porcelanatos™</span>. Todos los derechos reservados.
</span>
</footer>
