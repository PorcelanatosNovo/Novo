  ...
  return (
    ...
    <div className="block rounded-lg shadow-lg bg-white">
      <div className="flex flex-wrap items-center">
        <div className="grow-0 shrink-0 basis-auto  w-full lg:flex lg:w-6/12 xl:w-4/12 flex align-center justify-center">
          <Image src="/ceramicos.jpg" 
          alt="ceramicos"
          width={400}
          height={400}
        ...
        <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
          <div className="px-6 py-12 md:px-12">
            <h2 className="text-3xl font-bold mb-6 uppercase">Somos Nuevos Porcelanatos</h2>
