...
function Heroe(router:any) {
  return (
    <div className='overflow-x-hidden bg-[url("/marbel.webp")] flex flex-col items-center justify-center lg:grid lg:grid-cols-3	lg:grid-rows-1 px-6 lg:py-12 sm:py-6 md:px-12 text-gray-800 text-center lg:text-left lg:gap-x-16	min-h-screen lg:min-h-0'>
    ...
    >
      <a href='https://novoporcelanatos468381923.mercadoshops.com.ar/' target="_blank" rel='noopener noreferrer'>
       ...
       <div className='lg:col-span-3 lg:grid lg:place-items-center  w-fit mx-auto'>
       <a href='https://walink.co/baa647' target='_blank' rel="noopener noreferrer" className='button button--neon hover:bg-[#dc2626] uppercase font-semibold lg:text-xl'>Consultar por precios en efectivo</a>
       </div>
    </div>
  )
}
