...
<div className="buttons my-10 flex flex-wrap justify-center align-center">
          ...
          Enviar Mensaje</a>
          <a href='https://ceramicasnet.mercadoshops.com.ar' target='_blank' rel='noopener noreferrer' className="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-xl px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
          Tienda online</a>
