            ...
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  <Link href="/" passHref ><span className=" lg:hidden h-8 w-auto text-white flex text-xl	"> <span className='text-red-600 text-2xl	 '>novo</span> Porcelanatos<Image src="/logo4.png" className="mr-3 h-8" alt=" Logo" width={50} height={30}/></span></Link>
